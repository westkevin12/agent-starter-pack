...
def parse_args() -> argparse.Namespace:
    ...
    required_params = {
        ...
        "vector_search_index": parsed_args.vector_search_index,
        "vector_search_index_endpoint": parsed_args.vector_search_index_endpoint,
...
if __name__ == "__main__":
    ...
    logging.info(f"vector_search_index: {args.vector_search_index}")
    logging.info(f"vector_search_index_endpoint: {args.vector_search_index_endpoint}")
    ...
    pipeline_job_params = {
        ...
        "parameter_values": {
            ...
            "vector_search_index_endpoint": args.vector_search_index_endpoint,
        },
    }
